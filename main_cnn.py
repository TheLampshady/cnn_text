...
# Load data
print("Loading data...")
data, target = data_helpers.load_data_and_labels(FLAGS.positive_data_file, FLAGS.negative_data_file)
text_classifier = TextClassifier(data, target, FLAGS.dev_sample_percentage)
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        cnn = TextCNN(
        # cnn = TextCNNGit(
            sequence_length=text_classifier.sequence_length,
            num_classes=text_classifier.output_size,
            vocab_size=text_classifier.vocab_size,
        ...
        # Generate batches
        batches = text_classifier.train_batch(FLAGS.batch_size, FLAGS.num_epochs)
